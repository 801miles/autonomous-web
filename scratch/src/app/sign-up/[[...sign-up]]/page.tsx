...
export const metadata: Metadata = {
  title: "Get Started",
  description: "Create your Archon account. Five psychographic questions, four autonomous agents, one production-grade specification.",
};
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center px-6 py-32">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        ...
        <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-primary/12 blur-[160px] rounded-full" />
        <div className="absolute bottom-1/3 left-1/4 w-[350px] h-[350px] bg-cyan-500/8 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="flex flex-col items-center gap-8 w-full max-w-md">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Begin your first intake</h1>
            <p className="text-sm text-foreground/40 mt-1">
              Free forever. Pay only when you export.
            </p>
          </div>
          {/* Value prop pills */}
          <div className="flex flex-wrap justify-center gap-2 mt-1">
            {["5 Golden Questions", "4 Autonomous Agents", "$0 to Start"].map((f) => (
              <span
                key={f}
                className="text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full bg-primary/8 border border-primary/15 text-primary/70"
              >
                {f}
              </span>
            ))}
